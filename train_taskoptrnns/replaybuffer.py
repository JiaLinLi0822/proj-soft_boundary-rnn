...
class BatchReplayBuffer(BaseReplayBuffer):
    ...
    def reformat(self):
        ...
        self.rollout['logits'] = torch.stack(self.rollout['logits'], dim = -1) # (batch_size, seq_len)
        self.rollout['logits'] *= self.rollout['masks']
...
if __name__ == '__main__':
    ...
    buffer.push(log_probs = 1, entropies = 2, values = 3, rewards = 4, masks = 5, logits = 6)
    print(buffer.pull('log_probs', 'entropies', 'values', 'rewards', 'masks', 'logits'))